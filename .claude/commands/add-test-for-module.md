---
description: Add comprehensive unit tests for the specified Python source code file. Example: `/add-test-for-module /path/to/shai_py/math_ops.py comprehensive "optional additional requirements"`
allowed-tools: Write(shai_py/**/*.py), Write(tests/**/*.py), Bash(.venv/bin/python tests/**/*.py)
---
